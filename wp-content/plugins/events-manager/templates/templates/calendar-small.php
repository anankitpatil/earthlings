 ...
 */
?>
<table class="em-calendar table table-striped">
	<thead>
		<tr>
			<td><a class="em-calnav em-calnav-prev" href="<?php echo esc_url($calendar['links']['previous_url']); ?>" rel="nofollow"><i class="fa fa-angle-left"></i></a></td>
			...
			<td><a class="em-calnav em-calnav-next" href="<?php echo esc_url($calendar['links']['next_url']); ?>" rel="nofollow"><i class="fa fa-angle-right"></i></a></td>
		</tr>
	</thead>
	<tbody>
		<tr class="days-names">
