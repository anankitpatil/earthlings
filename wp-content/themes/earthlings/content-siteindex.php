...
<div class="widget widget_pages">
	<h2 class="widgettitle"><?php _e( 'Site Content', 'earthlings' ); ?></h2>
	<ul>
	<?php
...
<div class="widget widget_categories">
	<h2 class="widgettitle"><?php _e( 'Categories', 'earthlings' ); ?></h2>
	<ul>
	<?php
...
$portfolio_types = wp_list_categories( array(
		'show_count' => true,
		'title_li'   => '', //_x ( 'Portfolio Categories', 'earthlings' ),
...
<div class="widget widget_portfolio_types">
	<h2 class="widgettitle"><?php _e( 'Portfolio Types', 'earthlings' ); ?></h2>
	<ul>
...
if ( $portfolio_tag_cloud ) {
	echo '<h2>' . __( 'Portfolio Tags', 'earthlings' ) . '</h2>';
...
/*
$archive_content = '<p>' . sprintf( __( 'Try looking in the monthly archives. %1$s', 'earthlings' ), convert_smilies( ':)' ) ) . '</p>';
