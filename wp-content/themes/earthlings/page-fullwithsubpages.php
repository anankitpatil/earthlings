...
<div id="primary" class="content-area-wide">
	<main id="main" class="site-main" role="main">
		...
		wp_reset_postdata();
		?>
					<?php edit_post_link( __( '<span class="glyphicon glyphicon-edit"></span> Edit', 'earthlings' ), '<div class="container"><footer class="entry-meta"><div class="edit-link">', '</div></div></footer>' ); ?>
