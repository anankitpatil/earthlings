 ...
 */
?>
<table class="em-calendar table-striped table">
	<thead>
		<tr>
			<td><a class="em-calnav em-calnav-prev" href="<?php echo esc_url($calendar['links']['previous_url']); ?>" rel="nofollow"><span class="glyphicon glyphicon-chevron-left"></span></a></td>
			...
			<td><a class="em-calnav em-calnav-next" href="<?php echo esc_url($calendar['links']['next_url']); ?>" rel="nofollow"><span class="glyphicon glyphicon-chevron-right"></span></a></td>
		</tr>
	</thead>
	<tbody>
		<tr class="days-names">
