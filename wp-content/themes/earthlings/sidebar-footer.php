	...
	<div class="container">
		<div class="row">
			...
			<aside id="sample-text" class="widget widget_text col-sm-4 clearfix">
				<h2 class="widget-title"><?php _e( 'About This Theme', 'earthlings' ); ?></h2>
				<p><?php _e( "You are previewing this theme, so we are showing some sample widgets here. Once you activate the theme, you can place from 1 to 4 widgets here or don't add any to remove this whole footer. Cool, huh?", 'earthlings' ); ?></p>
			</aside>
