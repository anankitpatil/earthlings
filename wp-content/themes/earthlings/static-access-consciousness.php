<div class="container">
    <div class="row">
    	<section class="col-lg-12 cat-content text-center">
            <h3>Empowering People to Know that they Know!</h3>
            <p>Consciousness includes everything and judges nothing!</p>
            <p>I know what you’re thinking... Easier said than done right??... and this believe me is what I thought as well until Access Consciousness came along. That’s when I started questioning and realised maybe this isn’t really true. Every time I used their tools, change became easy and just fun. Judgements of all kinds seemed to hold no value. So what if the whole journey of becoming more “conscious” was the most joyful experience you’ve ever had? Would you be willing to give it a try? If yes, then do read on and if it does interest you let’s have some “conscious” fun together!</p>
            <h4>What is Access Consciousness?</h6>
            <p>Access Consciousness offers self empowering and pragmatic tools to change things in your life that you haven’t been able to change until now.</p>
            <p>Access Consciousness provides you with ways to become totally aware and to begin to function as the conscious being you truly are.</p>
            <div class="embed-responsive embed-responsive-16by9">
                <iframe class="embed-responsive-item" src="//www.youtube.com/embed/-IL_GqlK7hw"></iframe>
            </div>
            <p>What if you, being you, is the gift and change this world requires? Is now the time?</p>
            <p>For more information please visit <a href="http://accessconsciousness.com">accessconsciousness.com</a></p>
        </section>
    </div>
    <div class="row">
