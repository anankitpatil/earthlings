<div class="container">
    <div class="row">
    	<section class="col-lg-12 cat-content text-center">
            <h3>Bring your inner creative child at the forefront!</h3>
            <p>This is the space where “therapy” truly brings your inner creative child at the forefront.</p>
            <p>What if you could express yourself truly without inhibition, without feeling threatened, without judgement using paints, crayons, drums, craft material, masks, skits, stories and poems? Would it be fun? Would you allow yourself to immerse into a space you haven’t allowed yourself to enter since maybe you were 6 years old? Would you allow yourself to enter a space of NO judgement? Would you allow yourself to be a child again?</p>
            <p>We bring to you visual art therapy, drumming and drum circles, spoken word, storytelling, peer group theatre and dance movement therapy with facilitators having unique expertise and experiences in each of the individual art forms. Our workshops are a combination of one or more of the above art based therapies targeted at <b>all kinds of groups ranging from kids to adults to geriatric groups</b>.</p>
        </section>
