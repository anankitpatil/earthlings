<div class="container">
    <div class="row">
    	<section class="col-lg-12 cat-content text-center">
            <h3>Tap into our own subconscious beliefs!</h3>
            <p>Yes! this is where we make you drowsy by making you watch an oscillating pendulum and then.. in a deep voice command.. “YOU ARE FEELING SLEEPY... SLEEPPPYYY”.. repeat it a few times over and then... just when you’re about to fall face down.. we make you “cluck like a chicken” in front of hundreds of people!!</p>
            <p>Hehe... well we wish that is what hypnosis was! :P</p>
            <p>But NO! Contrary to popular belief, Hypnosis is only a state of Altered Awareness in which access is available to the subconscious mind. It is a state of deep relaxation which allows us to then tap into our own subconscious beliefs which may be limiting us and can ONLY be accessed if WE CHOOSE to and give ourselves permission to!</p>
            <p>The sub-conscious mind is where all our limiting beliefs are stored. If we find ourselves in repeated limiting patterns, be it with our bodies, relationships, money, careers, chances are there is a limiting point of view hidden somewhere in our subconscious that we cannot access. Through hypnosis we gain access to it, so that we can change any and every situation we’d like to.</p>
            <p>Hypnosis thus, can be adapted for individual and group therapy.</p>
            <p>Some of the many issues hypnosis can help deal with:</p>
            <div class="row">
                ...
                <div class="col-md-8 text-left">
                    ...
                    <ol>
                        ...
                        <li>Boost performance quotient.</li>
                        <li>Create Positive Work Environment.</li>
                        <li>Increase Dynamism within working groups.</li>
                        <li>Increase team adaptability and versatility.</li>
                    </ol>
                    <p>Individuals:</p>
                    <ol>
                        <li>Depression</li>
                        <li>Asthma</li>
                        <li>Psoriasis Eczema, Allergies</li>
                        <li>Migraine</li>
                        <li>De-addiction</li>
                        ...
                        <li>Back pain, Joint pain, Arthritis</li>
                        <li>PCOD</li>
                        <li>Breathing problem</li>
                        <li>Insomnia</li>
                        <li>Accident and Surgical trauma, etc.</li>
                        <li>To get rid of exam related fear and anxiety, improve focus, concentration and overall performance</li>
                    </ol>
                </div>
                <div class="col-md-2"></div>
            </div>
